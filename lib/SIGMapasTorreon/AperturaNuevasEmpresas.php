<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon AperturaNuevasEmpresas
 *
...
/**
 * Clase AperturaNuevasEmpresas
 */
class AperturaNuevasEmpresas extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Apertura de Nuevas Empresas';
        $this->autor              = 'Dirección de Planeación Urbana Sustentable IMPLAN';
        $this->fecha              = '2020-07-08T10:51';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'apertura-nuevas-empresas';
        $this->imagen             = 'apertura-nuevas-empresas/imagen.jpg';
        $this->imagen_previa      = 'apertura-nuevas-empresas/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Apertura de Nuevas Empresas en la región.';
        $this->claves             = 'empresas, infraestructura';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/ce59f4ef-a265-4d83-8421-5865792e9a62/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/ce59f4ef-a265-4d83-8421-5865792e9a62/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
