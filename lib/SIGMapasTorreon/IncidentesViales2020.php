<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon IncidentesViales2020
 *
...
/**
 * Clase IncidentesViales2020
 */
class IncidentesViales2020 extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Incidentes Viales2020';
        $this->autor              = 'Dirección de Planeación Urbana Sustentable IMPLAN';
        $this->fecha              = '2020-05-08T17:00';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'incidentes-viales2020';
        $this->imagen             = 'incidentes-viales2020/imagen.jpg';
        $this->imagen_previa      = 'incidentes-viales2020/imagen-previa.jpg';
