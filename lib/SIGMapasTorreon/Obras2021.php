<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon Obras2021
 *
 ...
 * Clase Obras2021
 */
class Obras2021 extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Obras 2021';
        $this->autor              = 'Dirección de Proyectos Estratégicos, Implan';
        $this->fecha              = '2021-04-09T12:44';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'obras-2021';
        $this->imagen             = 'obras-2021/imagen.jpg';
        $this->imagen_previa      = 'obras-2021/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Georreferenciación de proyectos de Obra pública realizados en 2021 en el municipio de Torreón, Coahuila.';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/a93f93b1-809b-4a74-8bac-0cf4b7628217/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/a93f93b1-809b-4a74-8bac-0cf4b7628217/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
