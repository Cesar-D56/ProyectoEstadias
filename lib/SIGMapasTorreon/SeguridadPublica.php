<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon SeguridadPublica
 *
...
/**
 * Clase SeguridadPublica
 */
class SeguridadPublica extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Seguridad Pública';
        $this->autor              = 'Arq. Daniela Patricia Corral Hernández';
        $this->fecha              = '2015-12-07T16:17';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'seguridad-publica';
        $this->imagen             = 'seguridad-publica/imagen.jpg';
        $this->imagen_previa      = 'seguridad-publica/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Instituciones dedicadas a proteger la integridad de los ciudadanos y sus bienes.';
        $this->claves             = 'IMPLAN, Torreon, Seguridad';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/c8d95b00-92f6-11e5-857a-0e5db1731f59/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/c8d95b00-92f6-11e5-857a-0e5db1731f59/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
