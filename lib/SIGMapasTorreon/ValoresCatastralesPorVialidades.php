<?php
/**
 * TrcIMPLAN Sitio Web - SIGMapasTorreon ValoresCatastralesPorVialidades
 *
...
/**
 * Clase ValoresCatastralesPorVialidades
 */
class ValoresCatastralesPorVialidades extends \Base\Publicacion {
    ...
    public function __construct() {
        ...
        $this->nombre             = 'Valores Catastrales por Vialidades';
        $this->autor              = 'Dirección de Planeación Urbana Sustentable IMPLAN';
        $this->fecha              = '2020-03-31T12:00';
        // El nombre del archivo a crear y rutas relativas a las imágenes
        $this->archivo            = 'valores-catastrales-por-vialidades';
        $this->imagen             = 'valores-catastrales-por-vialidades/imagen.jpg';
        $this->imagen_previa      = 'valores-catastrales-por-vialidades/imagen-previa.jpg';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion        = 'Valores de Suelo y Construcción del Municipio de Torreón, Coahuila de Zaragoza para el Ejercicio Fiscal 2019.';
        $this->claves             = 'IMPLAN, Torreon, poblacion, catastrales, valores, suelo';
        ...
        $this->url                = 'https://implantorreon.carto.com/u/sigimplan/builder/ec7dfd05-86c5-48d5-bb49-80ae493eca32/embed';
        ...
        $mapa->theMap             = <<<FINAL
<iframe width="100%" height="520" frameborder="0" src="https://implantorreon.carto.com/u/sigimplan/builder/ec7dfd05-86c5-48d5-bb49-80ae493eca32/embed" allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
