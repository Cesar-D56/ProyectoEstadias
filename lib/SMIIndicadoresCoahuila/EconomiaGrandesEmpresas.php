<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila EconomiaGrandesEmpresas
 *
...
class EconomiaGrandesEmpresas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Grandes Empresas en Coahuila';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2014-07-31', 'valor' => '1.0400', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)')); // formateado 0, valor 4, crudo 2
    } // datos
