<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera
 *
...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Especialización Local en Industria Manufacturera en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Mercados, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '81.1136', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
