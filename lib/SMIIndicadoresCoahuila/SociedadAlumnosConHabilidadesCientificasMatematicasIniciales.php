<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadAlumnosConHabilidadesCientificasMatematicasIniciales
 *
...
class SociedadAlumnosConHabilidadesCientificasMatematicasIniciales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Alumnos con Habilidades Científicas-Matemáticas Iniciales en Coahuila';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-01', 'valor' => '56.3000', 'fuente_nombre' => 'SEP')); // formateado 0, valor 2, crudo 1
    } // datos
