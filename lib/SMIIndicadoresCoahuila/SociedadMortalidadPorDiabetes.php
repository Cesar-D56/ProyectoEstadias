<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadMortalidadPorDiabetes
 *
...
class SociedadMortalidadPorDiabetes extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Mortalidad por Diabetes en Coahuila';
...
Se incluye en el subíndice "Sociedad Incluyente, Preparada y Sana" de IMCO.';
    ...
    public function datos() {
        return array(
            ...
            array('fecha' => '2003-12-31', 'valor' => '7.9000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2004-12-31', 'valor' => '7.8000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2005-12-31', 'valor' => '8.7000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2006-12-31', 'valor' => '8.3000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2007-12-31', 'valor' => '8.0000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2008-12-31', 'valor' => '8.6000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2009-12-31', 'valor' => '8.6000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2010-12-31', 'valor' => '8.0000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2011-12-31', 'valor' => '8.0000', 'fuente_nombre' => 'SINAIS (SSA)'),
            array('fecha' => '2012-12-31', 'valor' => '7.7000', 'fuente_nombre' => 'SINAIS (SSA)', 'notas' => 'Dirección General de Información en Salud (DGIS). Base de datos de defunciones generales 1979-2007. [en línea]: Sistema Nacional de Información en Salud (SINAIS). [México]: Secretaría de Salud. [Consulta: 01 abril 2014].'),
            array('fecha' => '2013-12-31', 'valor' => '8.1000', 'fuente_nombre' => 'SINAIS (SSA)')); // formateado 0, valor 28, crudo 15
    } // datos
