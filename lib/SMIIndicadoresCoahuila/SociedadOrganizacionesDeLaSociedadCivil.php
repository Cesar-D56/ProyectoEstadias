<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadOrganizacionesDeLaSociedadCivil
 *
...
class SociedadOrganizacionesDeLaSociedadCivil extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Organizaciones de la Sociedad Civil en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Participación Ciudadana, Gobierno, Índice de Competitividad Urbana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-11-25', 'valor' => '26.4300', 'fuente_nombre' => 'RFOSC')); // formateado 0, valor 2, crudo 1
    } // datos
