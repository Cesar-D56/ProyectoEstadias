<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresCoahuila SociedadRazonEntreMujeresYHombresEnLaEnsenanzaMediaSuperior
 *
...
class SociedadRazonEntreMujeresYHombresEnLaEnsenanzaMediaSuperior extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Razón entre Mujeres y Hombres en la Enseñanza Media Superior en Coahuila';
        ...
        $this->claves      = 'IMPLAN, Coahuila, Educación, Género, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '0.9940', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda')); // formateado 0, valor 2, crudo 1
    } // datos
