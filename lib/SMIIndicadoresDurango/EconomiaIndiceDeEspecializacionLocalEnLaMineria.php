<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango EconomiaIndiceDeEspecializacionLocalEnLaMineria
 *
...
class EconomiaIndiceDeEspecializacionLocalEnLaMineria extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Especialización Local en la Minería en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '10.6270', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
