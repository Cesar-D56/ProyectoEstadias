<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango EconomiaIndiceDeEspecializacionLocalEnServicios
 *
...
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Especialización Local en Servicios en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Mercados';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '9.4728', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
