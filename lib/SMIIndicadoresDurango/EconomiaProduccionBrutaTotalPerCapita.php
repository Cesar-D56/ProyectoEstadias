<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango EconomiaProduccionBrutaTotalPerCapita
 *
...
class EconomiaProduccionBrutaTotalPerCapita extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Producción Bruta Total Per Cápita en Durango';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '63345.06', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
