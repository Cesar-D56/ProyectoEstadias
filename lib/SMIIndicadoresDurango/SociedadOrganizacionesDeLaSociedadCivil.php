<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresDurango SociedadOrganizacionesDeLaSociedadCivil
 *
...
class SociedadOrganizacionesDeLaSociedadCivil extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Organizaciones de la Sociedad Civil en Durango';
        ...
        $this->claves      = 'IMPLAN, Durango, Participación Ciudadana, Gobierno, Índice de Competitividad Urbana';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2016-11-25', 'valor' => '143.3800', 'fuente_nombre' => 'RFOSC')); // formateado 0, valor 2, crudo 1
    } // datos
