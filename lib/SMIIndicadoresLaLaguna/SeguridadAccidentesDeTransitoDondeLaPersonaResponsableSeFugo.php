<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SeguridadAccidentesDeTransitoDondeLaPersonaResponsableSeFugo
 *
...
class SeguridadAccidentesDeTransitoDondeLaPersonaResponsableSeFugo extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Accidentes de tránsito donde la persona responsable se fugó en La Laguna';
    ...
    public function datos() {
        return array(
            array('fecha' => '2015-12-31', 'valor' => '10.2000', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2016-12-31', 'valor' => '9.4000', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2017-12-31', 'valor' => '8.6000', 'fuente_nombre' => 'INEGI'),
            array('fecha' => '2018-12-31', 'valor' => '11.3600', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 8, crudo 4
    } // datos
