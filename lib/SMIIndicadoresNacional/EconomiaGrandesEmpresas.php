<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaGrandesEmpresas
 *
...
class EconomiaGrandesEmpresas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Grandes Empresas en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '0.6300', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)'),
            array('fecha' => '2014-07-31', 'valor' => '0.5900', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)')); // formateado 0, valor 4, crudo 2
    } // datos
