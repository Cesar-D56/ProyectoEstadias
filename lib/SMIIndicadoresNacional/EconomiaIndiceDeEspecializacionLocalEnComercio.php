<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaIndiceDeEspecializacionLocalEnComercio
 *
...
class EconomiaIndiceDeEspecializacionLocalEnComercio extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Especialización Local en Comercio en Nacional';
