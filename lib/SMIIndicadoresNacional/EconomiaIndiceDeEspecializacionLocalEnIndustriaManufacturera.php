<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera
 *
...
class EconomiaIndiceDeEspecializacionLocalEnIndustriaManufacturera extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Especialización Local en Industria Manufacturera en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Mercados, Sector Automotriz';
        // Para el Organizador
