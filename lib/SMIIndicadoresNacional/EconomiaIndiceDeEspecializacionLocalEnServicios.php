<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaIndiceDeEspecializacionLocalEnServicios
 *
 ...
 */
class EconomiaIndiceDeEspecializacionLocalEnServicios extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Índice de Especialización Local en Servicios en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Mercados';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '16.5500', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI'),
            array('fecha' => '2013-12-31', 'valor' => '16.5100', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 4, crudo 2
    } // datos
