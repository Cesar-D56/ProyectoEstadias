<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaInversionExtranjeraDirecta
 *
...
class EconomiaInversionExtranjeraDirecta extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Inversión Extranjera Directa en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2012-12-31', 'valor' => '20685.96', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI y la Secretaría de Economía')); // formateado 0, valor 2, crudo 1
    } // datos
