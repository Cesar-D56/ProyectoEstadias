<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaMedianasEmpresas
 *
...
class EconomiaMedianasEmpresas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Medianas Empresas en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '1.2900', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)'),
            array('fecha' => '2014-07-31', 'valor' => '1.1900', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)')); // formateado 0, valor 4, crudo 2
    } // datos
