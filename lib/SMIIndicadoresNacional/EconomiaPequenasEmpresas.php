<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaPequenasEmpresas
 *
 ...
 */
class EconomiaPequenasEmpresas extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Pequeñas Empresas en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Empresas';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '5.5000', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)'),
            array('fecha' => '2014-07-31', 'valor' => '5.2200', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)')); // formateado 0, valor 4, crudo 2
    } // datos
