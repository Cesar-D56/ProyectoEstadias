<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaProduccionBrutaTotalPerCapita
 *
...
class EconomiaProduccionBrutaTotalPerCapita extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Producción Bruta Total Per Cápita en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '103094.92', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI'),
            array('fecha' => '2013-12-31', 'valor' => '118115.69', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 4, crudo 2
    } // datos
