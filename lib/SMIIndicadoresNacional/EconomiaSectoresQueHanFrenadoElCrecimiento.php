<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaSectoresQueHanFrenadoElCrecimiento
 *
 ...
 */
class EconomiaSectoresQueHanFrenadoElCrecimiento extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Sectores que Han Frenado el Crecimiento en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2008-12-31', 'valor' => '25.6600', 'fuente_nombre' => 'Elaboración propia con datos obtenidos del INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
