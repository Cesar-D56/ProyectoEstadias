<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional EconomiaTotalDeEmpresasRegistradasEnElSiem
 *
...
class EconomiaTotalDeEmpresasRegistradasEnElSiem extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Total de Empresas Registradas en el SIEM en Nacional';
    ...
    public function datos() {
        return array(
            array('fecha' => '2013-12-31', 'valor' => '666684', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)'),
            array('fecha' => '2014-07-31', 'valor' => '701136', 'fuente_nombre' => 'Sistema de Información Empresarial Mexicano (SIEM)')); // formateado 0, valor 4, crudo 2
    } // datos
