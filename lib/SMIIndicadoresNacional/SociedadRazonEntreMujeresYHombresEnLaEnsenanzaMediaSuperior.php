<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SociedadRazonEntreMujeresYHombresEnLaEnsenanzaMediaSuperior
 *
...
class SociedadRazonEntreMujeresYHombresEnLaEnsenanzaMediaSuperior extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Razón entre Mujeres y Hombres en la Enseñanza Media Superior en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Educación, Género, Objetivos del Milenio, Sector Automotriz';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '1.0140', 'fuente_nombre' => 'INEGI. Censos de Población y Vivienda')); // formateado 0, valor 2, crudo 1
    } // datos
