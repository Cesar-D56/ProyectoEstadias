<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresNacional SustentabilidadDisponibilidadDeBanqueta
 *
...
class SustentabilidadDisponibilidadDeBanqueta extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        parent::__construct();
        // Título y fecha
        $this->nombre      = 'Disponibilidad de Banqueta en Nacional';
        ...
        $this->claves      = 'IMPLAN, Nacional, Infraestructura, Movilidad, Vialidad';
        // Para el Organizador
    ...
    public function datos() {
        return array(
            array('fecha' => '2010-12-31', 'valor' => '71.0000', 'fuente_nombre' => 'INEGI')); // formateado 0, valor 2, crudo 1
    } // datos
